...
<head>
    ...
    <title>View Employer Profile - Jobseeker Panel</title>
</head>

<body>
<div class='container pt-5'>
    <div class="jumbotron">
        <h1>Viewing Employer Profile</h1>
    ...
    <?php
        $sql2 = "SELECT * FROM `employers` WHERE emp_id = '" . $_GET["emp_id"]."'";
    ...
    <div>
        <table class='table table-dark table-responsive-sm'>
            ...
            <tr><td>Company Type</td><td><?php echo $companytype; ?></td></tr>
